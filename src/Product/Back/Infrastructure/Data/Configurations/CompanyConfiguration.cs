...
/// <summary>
/// Configuración EF Core para Company en Product.
/// Company es SSOT en Admin; Product mantiene la entidad para referencias locales y relaciones.
/// </summary>
public class CompanyConfiguration : IEntityTypeConfiguration<GesFer.Product.Back.Domain.Entities.Company>
{
    ...
    public void Configure(EntityTypeBuilder<GesFer.Product.Back.Domain.Entities.Company> builder)
    {
        ...
        // Relaciones de dirección (opcionales) - compartidas con Admin
