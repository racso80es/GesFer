...
/// <summary>
/// Implementación del servicio de migraciones para Product.
/// </summary>
public class ProductMigrationService : IMigrationService
{
    ...
    public ProductMigrationService(ApplicationDbContext context, ILogger<ProductMigrationService> logger)
    {
        _context = context;
        _logger = logger;
    }
