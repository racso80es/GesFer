...
/// <summary>
/// Implementación de Product para la verificación de integridad y smoke test de la base de datos.
/// </summary>
public class ProductIntegrityService : IIntegrityCheckService
{
    ...
    /// <summary>
    /// Verifica que el usuario admin esté configurado correctamente con su compañía.
    /// Ejecuta un smoke test para asegurarse de que el sistema esté en un estado íntegro.
    /// </summary>
    ...
    private async Task EnsureAdminUserAsync()
    {
        ...
        async Task EnsureCoreAsync()
        {
            ...
            throw new InvalidOperationException("El usuario 'admin' debe estar definido en los seeds (demo-data.json o test-data.json).");
        }
