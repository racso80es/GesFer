...
public class ProductIntegrityService : IIntegrityCheckService
{
    ...
    public ProductIntegrityService(
        ...
        IAdminApiClient? adminApiClient = null) // Optional dependency
    {
        _context = context;
    ...
    public async Task EnsureIntegrityAsync()
    {
        ...
        if (_adminApiClient != null)
        {
            var company = await _adminApiClient.GetCompanyAsync(adminUser.CompanyId);
            if (company == null)
            {
    ...
    private async Task EnsureAdminUserAsync()
    {
        ...
        async Task EnsureCoreAsync()
        {
            ...
            if (admin != null)
            {
                ...
                if (_adminApiClient != null)
                {
                    var company = await _adminApiClient.GetCompanyAsync(admin.CompanyId);
                    if (company == null)
                    {
