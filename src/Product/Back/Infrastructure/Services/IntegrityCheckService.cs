...
{
    Task EnsureAdminUserAndSmokeTestAsync(ApplicationDbContext context, IServiceProvider services);
    Task EnsureAdminUserAsync(ApplicationDbContext context, IServiceProvider services);
}
...
public class IntegrityCheckService : IIntegrityCheckService
{
    ...
    /// </summary>
    public async Task EnsureAdminUserAsync(ApplicationDbContext context, IServiceProvider services)
    {
    ...
    /// </summary>
    public async Task EnsureAdminUserAndSmokeTestAsync(ApplicationDbContext context, IServiceProvider services)
    {
        context.ChangeTracker.Clear();
        await EnsureAdminUserAsync(context, services);
