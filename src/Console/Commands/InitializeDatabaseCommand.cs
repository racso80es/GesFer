...
public class InitializeDatabaseCommand : ICommandHandler<InitializeDatabaseInput, InitializationResultData>
{
    ...
    public async Task<CommandResult<InitializationResultData>> HandleAsync(InitializeDatabaseInput input)
    {
        ...
        try
        {
            ...
            // Servicios refactorizados para DbInitializer
            services.AddScoped<IIntegrityCheckService, ProductIntegrityService>();

            // IAdminApiClient requerido por ProductIntegrityService (optional but good to have)
            ...
            using (serviceProvider as IDisposable)
            {
                ...
                var productSeeder = scopedServices.GetRequiredService<JsonDataSeeder>();
                ...
                try
                {
                    ...
                    await productSeeder.SeedMasterDataAsync();
                    ...
                    {
                        await productSeeder.SeedTestDataAsync();
                    }
                    else
                    {
                        await productSeeder.SeedDemoDataAsync();
                    }
