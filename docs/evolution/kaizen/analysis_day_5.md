...
2.  **GesFer.Infrastructure:**
    ...
    *   **Warning CS8629 (`ProductDbContext.cs`):** Acceso inseguro a `GetMaxLength().Value`. Aunque lógico en el contexto, el compilador advierte sobre posible `InvalidOperationException`.
...
2.  Corregir el acceso nullable en `ProductDbContext`.
