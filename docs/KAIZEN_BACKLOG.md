...
*   **Origen:** `docs/audits/AUDITORIA_KAIZEN_2026_03_06.md`
*   **Descripción:** `GoldenRulesComplianceService` reporta falsos positivos en Seeds y Tests. Ignora entidades relacionales o complejas (`PurchaseInvoice`, `SalesInvoice`, `PurchaseDeliveryNote`, `SalesDeliveryNote`, `Tariff`, `TariffItem`).
*   **Impacto:** Reduce la confianza en las herramientas de salud del sistema, impidiendo detectar regresiones reales.
*   **Estado:** En Progreso (Rama `kaizen/daily-2026-03-06`).
