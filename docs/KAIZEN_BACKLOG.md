...
### [Alta] Fix Console AdminApiClient Registration (2026-02-24)
*   **Origen:** `docs/KAIZEN/2026-02-24_ANALYSIS.md`
*   **Descripción:** `InitializeDatabaseCommand` en Console no registra `IAdminApiClient`, causando que el Smoke Test de integridad Admin-Product se salte silenciosamente.
*   **Impacto:** Riesgo de inconsistencia de datos (CompanyId inválido) que bloquea la interacción con Clientes.
*   **Estado:** En Progreso (Rama `kaizen/daily-fix-admin-check`).
