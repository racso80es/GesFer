...
| :--- | :--- | :--- |
| **Violaciones de Terminología ("empresa")** | **192** | 🔴 CRÍTICO |
...
- **src/Product/Front/INSTRUCCIONES.md**
  - Line 82: `- **Empresa**: `Empresa Demo`...`
- **src/Product/Front/auth.ts**
  - Line 17: `company: { label: "Empresa", type: "text" },...`
...
- **src/Product/Front/tests/page-objects/DashboardPage.ts**
  - Line 11: `readonly empresasLink: Locator;...`
  - Line 21: `this.empresasLink = page.getByTestId('dashboard-companies-link').or(page.getByRole('link', { name: /...`
  - Line 43: `* Navega a la sección de empresas...`
  - ... y 1 más.
- **src/Product/Front/tests/page-objects/LoginPage.ts**
  - Line 10: `readonly empresaInput: Locator;...`
  - Line 21: `this.empresaInput = page.getByTestId('login-empresa-input').or(page.getByLabel(/organización|organiz...`
  - Line 40: `async login(empresa: string, usuario: string, password: string) {...`
  - ... y 1 más.
...
- **src/Product/Front/tests/api/api-client.ts**
  - Line 72: `async login(empresa: string, usuario: string, contraseña: string): Promise<string> {...`
  - Line 74: `empresa,...`
  - Line 92: `async loginFull(empresa: string, usuario: string, contraseña: string): Promise<any> {...`
  - ... y 2 más.
...
- **src/Product/Front/lib/validations/company.ts**
  - Line 5: `* Esquema de validación para crear empresa...`
  - Line 41: `* Esquema de validación para actualizar empresa...`
...
- **src/Product/Front/app/[locale]/companies/page.tsx**
  ...
  - Line 254: `{/* Modal Crear Empresa */}...`
  - Line 272: `{/* Modal Editar Empresa */}...`
...
- **src/Product/Front/app/(client)/companies/page.tsx**
  - Line 107: `console.error("Error al eliminar empresa:", error);...`
  - Line 130: `data-testid="shared-button-empresas-new-company"...`
  - Line 162: `data-testid="shared-button-empresas-create-first"...`
  - ... y 9 más.
