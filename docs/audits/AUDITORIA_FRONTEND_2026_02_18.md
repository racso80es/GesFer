...
La auditoría del día 2026-02-18 muestra un estado óptimo.
...
| **Type Safety** | Uso explícito de `any` | 2 | 🟡 Advertencia |
...
Se detectó el uso de `any` explícito.

- **Archivo:** `src/Product/Front/components/companies/company-form.spec.tsx`
  - Línea 65: `const initialData: any = {...`
- **Archivo:** `src/Product/Front/components/companies/company-form.tsx`
  - Línea 110: `const dataToSubmit: any = { ...values };...`
