# Script para insertar datos de seed en la base de datos
# Este script ejecuta los scripts SQL organizados:
# - master-data.sql (datos maestros)
# - sample-data.sql (datos de muestra)
# - test-data.sql (datos de prueba, opcional)
...
Write-Host "=== Insertando Datos de Seed en GesFer ===" -ForegroundColor Cyan
Write-Host ""
...
Write-Host ""
Write-Host "=== Datos de Seed Insertados ===" -ForegroundColor Cyan
Write-Host ""
