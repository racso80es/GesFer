...
## 3. Futuro de constitución
1. Core será siendo disgregada en más dominios.

---

## 4. El Sistema de Consciencia (Legacy / En Refactorización)

> **Deuda Técnica:** La relación entre la arquitectura definida anteriormente y las entidades de Juez y Auditor descritas a continuación queda pendiente de refactorización para alinearse completamente con los nuevos principios arquitectónicos.
...
*   **IOTA/Blockchain como Backend**: La persistencia de la "Consciencia" debe residir en un registro inmutable. Aunque inicialmente puede ser simulado, la arquitectura debe soportar una integración transparente con tecnologías de contabilidad distribuida (DLT) como IOTA.
...
### 4.4. Kaizen como Requisito de Compilación
